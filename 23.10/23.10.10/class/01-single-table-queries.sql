...
SELECT LastName, FirstName, Country FROM Country IN ('Canada', 'Germany', 'France');
SELECT LastName, FirstName, Country FROM Country NOT IN ('Canada', 'Germany', 'France');
...
-- 에러 해결
SELECT Composer, AVG(Milliseconds / 60000) AS avgOfMinute FROM tracks HAVING avgOfMinute < 10 GROUP BY Composer;